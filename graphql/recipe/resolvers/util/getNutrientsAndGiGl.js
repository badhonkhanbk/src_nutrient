...
// async function getGlAndNetCarbs2(ingredientsInfo: BlendIngredientInfo[]) {
//   let res = [];
//   let overAllGi = 0;
//   let overAllCarbs = 0;
//   let overAllFiber = 0;
...
//   };
// }
// async function getChild(parent: any, returnNutrients: any[]) {
//   let obj: any = {};
//   let childs: any = await BlendNutrientModel.find({ parent: parent })
//     .lean()
...
//     let mathchedNutrient = returnNutrients.filter(
//       (nutrient) =>
//         String(nutrient.blendNutrientRefference._id) === String(childs[i]._id)
//     )[0];
//     if (!mathchedNutrient) {
...
//     childs[i].childs = await getChild(
//       childs[i].blendNutrientRefference._id,
//       returnNutrients
//     );
...
//   return obj;
// }
// async function getTopLevelChilds(category: any, returnNutrients: any[]) {
//   let obj: any = {};
//   let childs = await BlendNutrientModel.find({
//     category: category,
...
//     .sort({ rank: 1 });
//   //@ts-ignore
//   let populatedChild: any = childs.map((child) => {
//     let data: any = returnNutrients.filter(
//       (rn) => String(rn.blendNutrientRefference._id) === String(child._id)
//     )[0];
//     if (!data) {
//       data = {
//         value: 0,
...
//     return data;
//   });
//   let populatedChild2: any = populatedChild.filter(
//     //@ts-ignore
...
//     obj[name.toLowerCase()].childs = await getChild(
//       populatedChild2[i].blendNutrientRefference._id,
//       returnNutrients
//     );
//   }
//   return obj;
